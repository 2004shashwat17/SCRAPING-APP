...
// Removed static mock `dailyActivityData` since activity data comes from the API
...
const StatCard: React.FC<StatCardProps> = ({
  ...
  // theme not required here; remove unused variable to satisfy linter
      ...
      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3, mb: 3 }}>
        ...
        <Box sx={{ flex: '1 1 300px', minWidth: '250px' }}>
          <StatCard
            ...
            value={threatAlerts?.length?.toString() || dashboardData?.activeThreats?.toString() || "0"}
